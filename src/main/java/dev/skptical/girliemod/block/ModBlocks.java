package dev.skptical.girliemod.block;
...
public class ModBlocks {
    ...
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, GirlieMod.MOD_ID);
    public static ArrayList<RegistryObject<Block>> BLOCK_LIST = new ArrayList<>();
    ...
    private static <T extends Block> RegistryObject<T> registerBlock(String name, Supplier<T> block){
        ...
        BLOCK_LIST.add((RegistryObject<Block>) toReturn);
        return toReturn;
